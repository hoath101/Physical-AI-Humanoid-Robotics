...
const config: Config = {
  ...
  url: 'https://github.com/hoth101', // TODO: Replace with your actual domain
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/hoath101/Physical-AI-Humanoid-Robotics/tree/main/',
        },
        blog: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/hoath101/Physical-AI-Humanoid-Robotics.git',
          label: 'GitHub',
          position: 'right',
        },
      ],
